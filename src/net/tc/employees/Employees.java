...
public class Employees  implements java.io.Serializable {
    ...
    public Employees(int empNo, Date birthDate, String firstName, String lastName, char gender, Date hireDate, Set titleses, Set salarieses, Set deptEmps, Set deptManagers) {
       this.empNo = empNo;
       this.birthDate = birthDate;
       this.firstName = firstName;
       this.lastName = lastName;
