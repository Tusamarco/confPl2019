 ...
 * @see net.tc.sakila.proxysqlcp.world.City
...
public class CityHome {
	...
	public City findById(java.lang.Integer id) {
		...
		try {
			City instance = (City) sessionFactory.getCurrentSession().get("net.tc.proxysqlcp.City", id);
			if (instance == null) {
	...
	public List findByExample(City instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("net.tc.proxysqlcp.City")
