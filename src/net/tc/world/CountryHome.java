 ...
 * @see net.tc.sakila.proxysqlcp.world.Country
...
public class CountryHome {
	...
	public Country findById(java.lang.String id) {
		...
		try {
			Country instance = (Country) sessionFactory.getCurrentSession().get("net.tc.proxysqlcp.Country", id);
			if (instance == null) {
	...
	public List findByExample(Country instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("net.tc.proxysqlcp.Country")
