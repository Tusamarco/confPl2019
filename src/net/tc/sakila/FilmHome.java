...
public class FilmHome {
	...
	public Film findById(java.lang.Short id) {
		...
		try {
			Film instance = (Film) sessionFactory.getCurrentSession().get("net.tc.sakila.Film", id);
			if (instance == null) {
	...
	public List findByExample(Film instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("net.tc.sakila.Film")
