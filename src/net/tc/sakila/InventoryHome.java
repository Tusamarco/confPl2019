...
public class InventoryHome {
	...
	public Inventory findById(java.lang.Integer id) {
		...
		try {
			Inventory instance = (Inventory) sessionFactory.getCurrentSession().get("net.tc.sakila.Inventory", id);
			if (instance == null) {
	...
	public List findByExample(Inventory instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("net.tc.sakila.Inventory")
