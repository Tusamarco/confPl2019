...
public class CustomerHome {
	...
	public Customer findById(java.lang.Short id) {
		...
		try {
			Customer instance = (Customer) sessionFactory.getCurrentSession().get("net.tc.sakila.Customer", id);
			if (instance == null) {
	...
	public List findByExample(Customer instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("net.tc.sakila.Customer")
