...
public class StoreHome {
	...
	public Store findById(java.lang.Byte id) {
		...
		try {
			Store instance = (Store) sessionFactory.getCurrentSession().get("net.tc.sakila.Store", id);
			if (instance == null) {
	...
	public List findByExample(Store instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("net.tc.sakila.Store")
