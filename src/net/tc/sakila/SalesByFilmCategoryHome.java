 ...
 * @see net.tc.sakila.SalesByFilmCategory
...
public class SalesByFilmCategoryHome {
	...
	public SalesByFilmCategory findById(net.tc.sakila.SalesByFilmCategoryId id) {
		...
		try {
			SalesByFilmCategory instance = (SalesByFilmCategory) sessionFactory.getCurrentSession()
					.get("net.tc.sakila.SalesByFilmCategory", id);
			if (instance == null) {
	...
	public List findByExample(SalesByFilmCategory instance) {
		log.debug("finding SalesByFilmCategory instance by example");
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("net.tc.sakila.SalesByFilmCategory")
