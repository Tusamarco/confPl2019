...
public class CategoryHome {
	...
	public Category findById(java.lang.Byte id) {
		...
		try {
			Category instance = (Category) sessionFactory.getCurrentSession().get("net.tc.sakila.Category", id);
			if (instance == null) {
	...
	public List findByExample(Category instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("net.tc.sakila.Category")
