...
public class StaffHome {
	...
	public Staff findById(java.lang.Byte id) {
		...
		try {
			Staff instance = (Staff) sessionFactory.getCurrentSession().get("net.tc.sakila.Staff", id);
			if (instance == null) {
	...
	public List findByExample(Staff instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("net.tc.sakila.Staff")
