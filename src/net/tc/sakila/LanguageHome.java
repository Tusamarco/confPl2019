...
public class LanguageHome {
	...
	public Language findById(java.lang.Byte id) {
		...
		try {
			Language instance = (Language) sessionFactory.getCurrentSession().get("net.tc.sakila.Language", id);
			if (instance == null) {
	...
	public List findByExample(Language instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("net.tc.sakila.Language")
