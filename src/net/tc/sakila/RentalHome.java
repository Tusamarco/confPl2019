...
public class RentalHome {
	...
	public Rental merge(Rental detachedInstance) {
		...
		try {
			Rental result = (Rental) sessionFactory.getCurrentSession().merge(detachedInstance);
	...
	public Rental findById(java.lang.Integer id) {
		...
		try {
			Rental instance = (Rental) sessionFactory.getCurrentSession().get("net.tc.sakila.Rental", id);
			if (instance == null) {
	...
	public List findByExample(Rental instance) {
		log.debug("finding Rental instance by example");
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("net.tc.sakila.Rental")
