...
public class CountryHome {
	...
	public Country findById(java.lang.Short id) {
		...
		try {
			Country instance = (Country) sessionFactory.getCurrentSession().get("net.tc.sakila.Country", id);
			if (instance == null) {
	...
	public List findByExample(Country instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("net.tc.sakila.Country")
