 ...
 * @see net.tc.sakila.FilmCategory
...
public class FilmCategoryHome {
	...
	public FilmCategory findById(net.tc.sakila.FilmCategoryId id) {
		log.debug("getting FilmCategory instance with id: " + id);
		try {
			FilmCategory instance = (FilmCategory) sessionFactory.getCurrentSession().get("net.tc.sakila.FilmCategory",
					id);
			if (instance == null) {
	...
	public List findByExample(FilmCategory instance) {
		log.debug("finding FilmCategory instance by example");
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("net.tc.sakila.FilmCategory")
