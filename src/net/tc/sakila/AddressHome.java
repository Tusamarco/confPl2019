...
public class AddressHome {
	...
	public Address findById(java.lang.Short id) {
		...
		try {
			Address instance = (Address) sessionFactory.getCurrentSession().get("net.tc.sakila.Address", id);
			if (instance == null) {
	...
	public List findByExample(Address instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("net.tc.sakila.Address")
