...
public class CityHome {
	...
	public City findById(java.lang.Short id) {
		...
		try {
			City instance = (City) sessionFactory.getCurrentSession().get("net.tc.sakila.City", id);
			if (instance == null) {
	...
	public List findByExample(City instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("net.tc.sakila.City")
