...
public class PaymentHome {
	...
	public Payment findById(java.lang.Short id) {
		...
		try {
			Payment instance = (Payment) sessionFactory.getCurrentSession().get("net.tc.sakila.Payment", id);
			if (instance == null) {
	...
	public List findByExample(Payment instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("net.tc.sakila.Payment")
